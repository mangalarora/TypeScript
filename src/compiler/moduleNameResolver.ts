namespace ts {
    ...
    function createResolvedModuleWithFailedLookupLocations(
        ...
        if (resultFromCache) {
            if (!compilerOptions.cacheResolutions && failedLookupLocations.length) resultFromCache.failedLookupLocations.push(...failedLookupLocations);
        ...
        return {
            ...
            failedLookupLocations: !compilerOptions.cacheResolutions ? failedLookupLocations : emptyArray,
    ...
    export function resolveTypeReferenceDirective(typeReferenceDirectiveName: string, containingFile: string | undefined, options: CompilerOptions, host: ModuleResolutionHost, redirectedReference?: ResolvedProjectReference, cache?: TypeReferenceDirectiveResolutionCache, resolutionMode?: ResolutionMode): ResolvedTypeReferenceDirectiveWithFailedLookupLocations {
        ...
        let result = containingDirectory ? cache?.getFromCache(containingDirectory, typeReferenceDirectiveName, /*mode*/ undefined, redirectedReference) : undefined;
        if (result) {
            if (traceEnabled) {
        ...
        result = {
            resolvedTypeReferenceDirective,
            failedLookupLocations: !options.cacheResolutions ? failedLookupLocations : emptyArray,
            affectingLocations: initializeResolutionField(affectingLocations),
            resolutionDiagnostics: initializeResolutionField(diagnostics),
        };
    ...
    export function createTypeReferenceDirectiveResolutionCache(
        ...
        const preDirectoryResolutionCache = createPerDirectoryResolutionCache(currentDirectory, getCanonicalFileName, directoryToModuleNameMap);
